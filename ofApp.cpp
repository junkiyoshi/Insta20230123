...
void ofApp::draw() {
	...
	for (int i = 0; i < 5; i++) {
		...
		target_list.push_back(glm::vec2(ofMap(ofNoise(ofRandom(1000), ofGetFrameNum() * 0.005), 0, 1, -230, 230), ofMap(ofNoise(ofRandom(1000), ofGetFrameNum() * 0.005), 0, 1, -230, 230)));
	}
